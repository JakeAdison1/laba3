...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        AbstractAction aboutProgrammAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                String photoPath = "C:\\Users\\admin\\Desktop\\Java\\лабораторная №3\\unnamed.jpg"; // Путь к фотографии

                String surname = "Околот";
                String name = "Данила";
                String group = "10";
                ...
                panel.setBackground(new Color(194, 178, 128)); // Песочный цвет
                JLabel surnameLabel = new JLabel("Фамилия: " + surname);
                JLabel nameLabel = new JLabel("Имя: " + name);
                JLabel groupLabel = new JLabel("Группа: " + group);
                JLabel photoLabel = new JLabel(new ImageIcon(photoPath));

                // Установить цвет текста на серый
                Color textColor = new Color(200, 100, 0); // Серый цвет
                surnameLabel.setForeground(textColor);
                nameLabel.setForeground(textColor);
                groupLabel.setForeground(textColor);
                photoLabel.setForeground(textColor); // Хотя это не имеет смысла для изображения, для единообразия
                ...
                // Добавление рамки
                panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Информация о программе"));
